...
import { api, isBackendConfigured } from "../../api/axios";
...
const Signup2 = ({ heading = "Create Account" }: Signup2Props) => {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validation: Check backend configuration
      ...
      // API call using reusable axios instance
      ...
      if (response.data.token) {
        ...
        setError("Error from backend: token access failed");
