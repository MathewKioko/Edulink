...
const CreateGroup: React.FC<postProps> = ({ post, setPost }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("/groups/create", dataToSend);
      ...
      const errorMsg = err.response?.data?.detail || "Error creating group";
      setError(errorMsg);
